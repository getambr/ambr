...
(
  ...
  'Mutual or one-way NDA between two individuals or entities — defines confidential information scope, term, surviving obligations, and remedies. Both parties sign via email magic link (no wallet required). Compliant with UETA/ESIGN, eIDAS Art. 25.',
  'peer',
