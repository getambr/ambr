...
(
  ...
  'Broad delegation of authority to an AI agent — defines action categories, spending caps, revocation terms, and principal liability. Structured with reference to UETA s. 14 (US) and eIDAS Art. 25 (EU).',
  'delegation',
...
(
  ...
  'An AI agent sells a defined service to a human consumer — covers scope, fees, delivery timeline, refund policy, and mandatory cooling-off period. Structured with reference to EU Consumer Rights Directive 2011/83/EU, UETA s. 14, and eIDAS Art. 25. Includes EU AI Act Art. 50 transparency disclosure.',
  'consumer',
...
(
  ...
  'Consumer subscribes to an AI-mediated service with recurring billing — covers monthly fee, SLA, cancellation, auto-renewal controls, and mandatory cooling-off. Structured with reference to EU Consumer Rights Directive, UETA s. 14, eIDAS Art. 25. No auto-renewal without explicit opt-in per EU directive.',
  'consumer',
...
(
  ...
  'AI agent commits to a guaranteed service outcome with enforceable liability caps and remedies. Covers warranty scope, liability limits, claim procedures, and arbitration. Consumer may reject arbitration in favor of small claims court. Structured per UCTA principles: no exclusion of liability for negligence or death.',
  'consumer',
...
(
  'p1-nda',
  'Non-Disclosure Agreement (P2P)',
  'Mutual or one-way NDA between two individuals or entities — defines confidential information scope, term, surviving obligations, and remedies. Both parties sign via email magic link (no wallet required). Structured with reference to UETA/ESIGN, eIDAS Art. 25.',
  'peer',
  '{"type":"object","required":["party_a_name","party_a_email","party_b_name","party_b_email","nda_type","confidential_scope","term_months","governing_law"],"properties":{"party_a_name":{"type":"string","description":"Full legal name of Party A (disclosing party in one-way NDA)"},"party_a_email":{"type":"string","format":"email","description":"Party A email for signing via magic link"},"party_b_name":{"type":"string","description":"Full legal name of Party B (receiving party in one-way NDA)"},"party_b_email":{"type":"string","format":"email","description":"Party B email for signing via magic link"},"nda_type":{"type":"string","enum":["mutual","one-way-a-to-b","one-way-b-to-a"],"description":"Mutual: both parties disclose. One-way: only one party discloses."},"confidential_scope":{"type":"string","description":"Description of what information is considered confidential"},"exclusions":{"type":"string","description":"What is NOT confidential (publicly known, independently developed, etc.)"},"term_months":{"type":"integer","description":"Duration of the NDA in months"},"surviving_obligations_months":{"type":"integer","default":24,"description":"How long confidentiality obligations survive after NDA expires"},"permitted_disclosures":{"type":"string","description":"Who else may receive the information (employees, advisors, etc.)"},"governing_law":{"type":"string","default":"Singapore","enum":["Singapore","Delaware","England-Wales","Switzerland","California","New-York"]}}}',
  50
)
