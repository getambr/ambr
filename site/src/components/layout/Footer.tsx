...
const platformLinks = [
  { href: 'https://getamber.dev/dashboard', label: 'Dashboard' },
  { href: 'https://getamber.dev/developers', label: 'Developers' },
  { href: 'https://getamber.dev/templates', label: 'Templates' },
  { href: 'https://getamber.dev/activate', label: 'Get Started' },
];

const communityLinks = [
  {
    href: 'https://x.com/ambr_run',
    label: 'X (Twitter)',
    icon: (
  ...
  {
    href: 'https://discord.gg/HjvJFfjr',
    label: 'Discord',
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    href: 'https://github.com/getambr/ambr',
    label: 'GitHub',
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    href: 'https://www.linkedin.com/company/113122990/',
    label: 'LinkedIn',
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-5">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 font-mono text-xs text-[#666]">
              Ricardian legal infrastructure for AI agents.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {platformLinks.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="font-mono text-xs text-[#666] hover:text-amber transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h3 className="font-mono text-xs uppercase tracking-wide text-text-primary mb-3">Community</h3>
            <ul className="space-y-2">
              {communityLinks.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className="inline-flex items-center gap-2 font-mono text-xs text-[#666] hover:text-amber transition-colors"
                  >
                    {link.icon}
                    {link.label}
                  </a>
