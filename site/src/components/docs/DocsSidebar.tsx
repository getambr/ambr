      ...
      <div className="mt-8 px-2 space-y-4">
        <div>
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <a href="https://www.linkedin.com/company/113122990/" target="_blank" rel="noopener noreferrer" className="text-[#555] hover:text-amber transition-colors" aria-label="LinkedIn">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
