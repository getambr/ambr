      ...
      <SectionWrapper className="rounded-2xl border border-border/50 bg-surface">
        <ScrollReveal>
          <div className="mb-6">
            ...
            <p className="text-text-secondary max-w-2xl">
              Planned integrations and features on the Ambr roadmap.
              These are not yet built — they represent the direction we&apos;re heading.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="rounded-xl border border-border bg-background p-5">
              ...
              <p className="text-sm text-text-secondary leading-relaxed">
                Mint a transferable compressed NFT containing the contract hash
                as on-chain proof of existence. Composable with DeFi protocols.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-background p-5">
              <h3 className="text-base font-semibold text-rose-400 mb-2">x402 Payment Rail</h3>
              <p className="text-sm text-text-secondary leading-relaxed">
                Contract hashes embedded in x402 payment metadata. Metered billing
                and settlement facilitation for agent-to-agent transactions.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-background p-5">
